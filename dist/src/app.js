...
var ScreenerTable_1 = require("./routes/screener/ScreenerTable");
...
var App = /** @class */ (function () {
    function App() {
        ...
        this.app.get('/screener/table', this.make(new ScreenerTable_1.ScreenerTable()));
    }
    App.prototype.make = function (route) {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, route.run(params)];
                    case 1:
                        json = _a.sent();
                        res.status(200);
    ...
    App.prototype.run = function (cron) {
        ...
        setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cron.run()];
                    case 1:
                        _a.sent();
                        setTimeout(function () {
                            _this.run(cron);

...
var DownloadBalanceSheetStatements = /** @class */ (function () {
    function DownloadBalanceSheetStatements() {
        this.delay = 0;
        this.repeat = 10000;
    }
    DownloadBalanceSheetStatements.prototype.run = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        ticker = tickers_1[_i];
                        return [4 /*yield*/, Api_1.Api.balanceSheetStatementsQuarterly(ticker.symbol)];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, DownloadUtils_1.DownloadUtils.uploadValues(values, ticker, 'BalanceSheetStatement', 'Quarter')];
                    case 5:
                        _c.sent();
                        _c.label = 6;
                    case 6:
                        _a++;
                        return [3 /*break*/, 4];
                    case 7: return [4 /*yield*/, Api_1.Api.balanceSheetStatementsYearly(ticker.symbol)];
                    case 8:
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, DownloadUtils_1.DownloadUtils.uploadValues(values, ticker, 'BalanceSheetStatement', 'Year')];
                    case 10:
                        _c.sent();
                        _c.label = 11;
                    case 11:
    ...
    return DownloadBalanceSheetStatements;
}());
exports.DownloadBalanceSheetStatements = DownloadBalanceSheetStatements;
//# sourceMappingURL=DownloadBalanceSheetStatements.js.map
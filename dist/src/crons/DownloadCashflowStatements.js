...
var DownloadCashflowStatements = /** @class */ (function () {
    function DownloadCashflowStatements() {
        this.delay = 0;
        this.repeat = 10000;
    }
    DownloadCashflowStatements.prototype.run = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        ticker = tickers_1[_i];
                        return [4 /*yield*/, Api_1.Api.cashflowStatementsQuarterly(ticker.symbol)];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, DownloadUtils_1.DownloadUtils.uploadValues(values, ticker, 'CashflowStatement', 'Quarter')];
                    case 5:
                        _c.sent();
                        _c.label = 6;
                    case 6:
                        _a++;
                        return [3 /*break*/, 4];
                    case 7: return [4 /*yield*/, Api_1.Api.cashflowStatementsYearly(ticker.symbol)];
                    case 8:
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, DownloadUtils_1.DownloadUtils.uploadValues(values, ticker, 'CashflowStatement', 'Year')];
                    case 10:
                        _c.sent();
                        _c.label = 11;
                    case 11:
    ...
    return DownloadCashflowStatements;
}());
exports.DownloadCashflowStatements = DownloadCashflowStatements;
//# sourceMappingURL=DownloadCashflowStatements.js.map